...
```bash
node .claude/skills/headless-web-viewer/scripts/render_url_playwright.mjs '<URL>' \
...
```bash
node .claude/skills/headless-web-viewer/scripts/render_url_playwright.mjs '<URL>' --print text
```
