...
<script type="module">
  ...
  // Render fenced ```mermaid blocks by converting them to <pre class="mermaid"> when possible.
  // This renderer preserves code blocks as <pre><code>; for CDN rendering, users can copy/paste the mermaid code.
</script>
""".strip()
